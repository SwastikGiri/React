...
import {logo,homepagelogo2, techeventslogo,funeventslogo,workshopslogo,footerlogo} from '../../public/images/image'
...
function Home() {
  return (
    ...
    <section>
        <header>
        <div
        className='w-full bg-cover flex flex-wrap' 
        style={{backgroundImage: 'url(/images/homepage.png)', height:'90vh'}}>
        <div className="relative w-full h-32 bg-transparent flex items-center">
    ...
    <section className='flex'>
        <img src={homepagelogo2} alt="Zen 3.0" />
    </section>
    <section className='p-10'>
        <h1 className='text-6xl font-bold text-center'>Events for you</h1>
        <br />
        <h6 className='text-sm text-center'>Everything has been made simple for you to scroll and get the most<br />out of the options available</h6>
        <div className='flex flex-wrap w-full items-center justify-between p-10'>
            <div style={{width:"33%"}}>
              <Link to='/tech'>
              <img src={techeventslogo} alt="Tech Events"/>
              </Link>
            </div>
            <div style={{width:"33%"}}>
              <Link to='/fun'>
              <img src={funeventslogo} alt="Fun Events" />
              </Link>
            </div>
            <div style={{width:"33%"}}>
              <Link to='/work'>
              <img src={workshopslogo} alt="Workshops" />
              </Link> 
            </div>
        </div>
    </section>
    <section className="relative overflow-hidden bg-slate-950 py-8 pt-32 pb-28">
        ...
        <div className="-m-8 flex flex-wrap items-center justify-between">
          <div className="w-auto p-8">
            ...
            <p className="text-white">
              Come and know more about Zairza and join our community to <br />{" "}
              experience more such amazing stuffs
            </p>
            <br />
            <br />
            <br />
            <span className="text-white text-sm">
              OUTR&#40;CET Campus &#41;, Kalinga Nagar, Ghatikia, Bhubaneswar,
              Odisha <br />
              +91 7205883336
            </span>
          </div>
          <div className="w-auto p-8"></div>
          <div className="w-auto p-8 flex flex-col items-center">
            <div className=" ml-32 flex flex-wrap justify-between">
              <div className="w-auto p-1.5 mr-4">
                <a href="#">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full border border-gray-300 hover:border-orange-400">
                    <svg
                      width="14"
                      height="20"
                      viewBox="0 0 8 14"
            ...
            <br />
            <br />
            <div className="text-white flex items-center justify-end ml-12">
              <div className="p-4 text-sm from-neutral-500">Presented by</div>
              <img style={{ width: "14%" }} src={footerlogo} alt="ZAIRZA" />
            </div>
          </div>
        </div>
      </div>
